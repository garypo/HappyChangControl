...
namespace Happy_Chang_Player
{
    class NoxAppProcess
    {
        ...
        protected Point stdAppCaptureSize = new Point(724, 1336);
        protected Point stdAppScreenSize = new Point(724, 1336);
        // measured from bmp captured
        protected int borderLeftCapture = 2;
        protected int borderRightCapture = 2;
        protected int borderTopCapture = 54;
        protected int borderBottomCapture = 2;
        protected int borderLeftOnScreen = 2;
        protected int borderRightOnScreen = 2;
        protected int borderTopOnScreen = 54;
        protected int borderBottomOnScreen = 2;
        ...
        public NoxAppProcess(ProcessStartInfo startInfo, float screenScale)
        {
            proc = Process.Start(startInfo);
            _screenScale = screenScale;
        }

        public NoxAppProcess(Process openedProc, float screenScale)
        {
            proc = openedProc;
            _screenScale = screenScale;
        }
